import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,f as t}from"./app-21PUpbL1.js";const p={},e=t(`<h1 id="对象键的展开" tabindex="-1"><a class="header-anchor" href="#对象键的展开" aria-hidden="true">#</a> 对象键的展开</h1><p>记录一道面试题，当时竟然没做出来：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">let</span> obj <span class="token operator">=</span> <span class="token punctuation">{</span>
