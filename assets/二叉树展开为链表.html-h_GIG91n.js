import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,f as e}from"./app-w-F4ET9i.js";const t="/fe-blog/assets/flatten1-9CKWOoT1.png",i="/fe-blog/assets/flatten2-FcIursRw.png",l={},o=e('<h1 id="二叉树展开为列表" tabindex="-1"><a class="header-anchor" href="#二叉树展开为列表" aria-hidden="true">#</a> 二叉树展开为列表</h1><p>给你二叉树的根结点 root ，请你将它展开为一个单链表：</p><p>展开后的单链表应该同样使用 TreeNode ，其中 right 子指针指向链表中下一个结点，而左子指针始终为 null 。 展开后的单链表应该与二叉树 先序遍历 顺序相同。</p><figure><img src="'+t+`" alt="转换" tabindex="0" loading="lazy"><figcaption>转换</figcaption></figure><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>输入：root = [1,2,5,3,4,null,6]
