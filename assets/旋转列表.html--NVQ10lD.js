import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as s,f as e}from"./app-5iZeq1HL.js";const t="/fe-blog/assets/rotate1-XCoYPXeq.jpeg",p={},o=e('<h1 id="旋转列表" tabindex="-1"><a class="header-anchor" href="#旋转列表" aria-hidden="true">#</a> 旋转列表</h1><p>给你一个链表的头节点 head ，旋转链表，将链表每个节点向右移动 k 个位置。</p><figure><img src="'+t+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>输入：head = [1,2,3,4,5], k = 2
输出：[4,5,1,2,3]
